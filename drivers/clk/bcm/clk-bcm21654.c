...
#define BCM21654_CCU_COMMON(_name, _capname) \
	KONA_CCU_COMMON(BCM21654, _name, _capname)
...
#define BCM21654_ROOT_CCU_CLK_COUNT	(BCM21654_ROOT_CCU_FRAC_1M + 1)

static struct ccu_data root_ccu_data = {
	BCM21654_CCU_COMMON(root, ROOT),
	/* no policy control */
	.kona_clks	= {
		[BCM21654_ROOT_CCU_FRAC_1M] =
			KONA_CLK(root, frac_1m, peri),
		[BCM21654_ROOT_CCU_CLK_COUNT] = LAST_KONA_CLK,
	},
};
...
#define BCM21654_AON_CCU_CLK_COUNT	(BCM21654_AON_CCU_PMU_BSC_APB + 1)

static struct ccu_data aon_ccu_data = {
	BCM21654_CCU_COMMON(aon, AON),
	.policy		= {
		.enable		= CCU_LVM_EN(0x0034, 0),
		.control	= CCU_POLICY_CTL(0x000c, 0, 1, 2),
	},
	.kona_clks	= {
		[BCM21654_AON_CCU_HUB_TIMER] =
			KONA_CLK(aon, hub_timer, peri),
		[BCM21654_AON_CCU_HUB_TIMER_APB] =
			KONA_CLK(aon, hub_timer_apb, bus),
		[BCM21654_AON_CCU_PMU_BSC] =
			KONA_CLK(aon, pmu_bsc, peri),
		[BCM21654_AON_CCU_PMU_BSC_APB] =
			KONA_CLK(aon, pmu_bsc_apb, bus),
		[BCM21654_AON_CCU_CLK_COUNT] = LAST_KONA_CLK,
	},
};
...
#define BCM21654_MASTER_CCU_CLK_COUNT	(BCM21654_MASTER_CCU_USB_OTG_AHB + 1)

static struct ccu_data master_ccu_data = {
	BCM21654_CCU_COMMON(master, MASTER),
	.policy		= {
		.enable		= CCU_LVM_EN(0x0034, 0),
		.control	= CCU_POLICY_CTL(0x000c, 0, 1, 2),
	},
	.kona_clks	= {
		[BCM21654_MASTER_CCU_SDIO1] =
			KONA_CLK(master, sdio1, peri),
		[BCM21654_MASTER_CCU_SDIO2] =
			KONA_CLK(master, sdio2, peri),
		[BCM21654_MASTER_CCU_SDIO3] =
			KONA_CLK(master, sdio3, peri),
		[BCM21654_MASTER_CCU_SDIO1_SLEEP] =
			KONA_CLK(master, sdio1_sleep, peri),
		[BCM21654_MASTER_CCU_SDIO2_SLEEP] =
			KONA_CLK(master, sdio2_sleep, peri),
		[BCM21654_MASTER_CCU_SDIO3_SLEEP] =
			KONA_CLK(master, sdio3_sleep, peri),
		[BCM21654_MASTER_CCU_SDIO1_AHB] =
			KONA_CLK(master, sdio1_ahb, bus),
		[BCM21654_MASTER_CCU_SDIO2_AHB] =
			KONA_CLK(master, sdio2_ahb, bus),
		[BCM21654_MASTER_CCU_SDIO3_AHB] =
			KONA_CLK(master, sdio3_ahb, bus),
		[BCM21654_MASTER_CCU_USB_OTG_AHB] =
			KONA_CLK(master, usb_otg_ahb, bus),
		[BCM21654_MASTER_CCU_CLK_COUNT] = LAST_KONA_CLK,
	},
};
...
#define BCM21654_SLAVE_CCU_CLK_COUNT	(BCM21654_SLAVE_CCU_BSC2_APB + 1)

static struct ccu_data slave_ccu_data = {
	BCM21654_CCU_COMMON(slave, SLAVE),
       .policy		= {
		.enable		= CCU_LVM_EN(0x0034, 0),
		.control	= CCU_POLICY_CTL(0x000c, 0, 1, 2),
	},
	.kona_clks	= {
		[BCM21654_SLAVE_CCU_UARTB] =
			KONA_CLK(slave, uartb, peri),
		[BCM21654_SLAVE_CCU_UARTB2] =
			KONA_CLK(slave, uartb2, peri),
		[BCM21654_SLAVE_CCU_UARTB3] =
			KONA_CLK(slave, uartb3, peri),
		[BCM21654_SLAVE_CCU_BSC1] =
			KONA_CLK(slave, bsc1, peri),
		[BCM21654_SLAVE_CCU_BSC2] =
			KONA_CLK(slave, bsc2, peri),
		[BCM21654_SLAVE_CCU_UARTB_APB] =
			KONA_CLK(slave, uartb_apb, bus),
		[BCM21654_SLAVE_CCU_UARTB2_APB] =
			KONA_CLK(slave, uartb2_apb, bus),
		[BCM21654_SLAVE_CCU_UARTB3_APB] =
			KONA_CLK(slave, uartb3_apb, bus),
		[BCM21654_SLAVE_CCU_BSC1_APB] =
			KONA_CLK(slave, bsc1_apb, bus),
		[BCM21654_SLAVE_CCU_BSC2_APB] =
			KONA_CLK(slave, bsc2_apb, bus),
		[BCM21654_SLAVE_CCU_CLK_COUNT] = LAST_KONA_CLK,
	},
};
...
CLK_OF_DECLARE(bcm21654_root_ccu, BCM21654_DT_ROOT_CCU_COMPAT,
			kona_dt_root_ccu_setup);
CLK_OF_DECLARE(bcm21654_aon_ccu, BCM21654_DT_AON_CCU_COMPAT,
			kona_dt_aon_ccu_setup);
CLK_OF_DECLARE(bcm21654_master_ccu, BCM21654_DT_MASTER_CCU_COMPAT,
			kona_dt_master_ccu_setup);
CLK_OF_DECLARE(bcm21654_slave_ccu, BCM21654_DT_SLAVE_CCU_COMPAT,
